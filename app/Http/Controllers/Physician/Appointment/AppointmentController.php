...
namespace App\Http\Controllers\Physician\Appointment;
...
use App\Filters\Physician\AppointmentFilters;
...
class AppointmentController extends Controller
{
        ...
        try {
            ...
            switch ($action) {
                case 'cancel':
                    ...
                    $this->appointment->sendServiceProviderCancelNotification($appointment, 'physician');
                    break;
    ...
    {
        try {
            $appointments = $this->appointment->getPhysicianAppointmentsGroupedByMonth();
