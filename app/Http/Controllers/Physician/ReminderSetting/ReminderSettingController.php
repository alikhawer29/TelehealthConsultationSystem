...
namespace App\Http\Controllers\Physician\ReminderSetting;

use Illuminate\Http\Request;
use Illuminate\Http\Response;
use App\Filters\Nurse\ReminderFilters;
...
class ReminderSettingController extends Controller
{
    ...
    {
        try {
            $data = $this->reminder->createReminder('nurse', $request->validated());
