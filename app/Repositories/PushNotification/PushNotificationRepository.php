...
class PushNotificationRepository extends BaseRepository implements PushNotificationRepositoryContract
{
    ...
    public function create(array $params)
    {
        ...
        try {
            ...
            $recipients->each(function ($recipient) use ($params) {
            ...
            //     Admin::first(),
            //     title: 'New Feedback',
            //     body: "{$feedback->user_type} {$feedback->name} has submitted a Feedback",
            //     data: [
            //         'route' => [
