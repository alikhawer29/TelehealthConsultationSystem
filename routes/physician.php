...
use App\Http\Controllers\Physician\Account\AccountController;
use App\Http\Controllers\Physician\Appointment\AppointmentController;
use App\Http\Controllers\Physician\Home\HomeController;
use App\Http\Controllers\Physician\Miscellaneous\GeneralController;
use App\Http\Controllers\Physician\Password\ForgetPasswordController;
use App\Http\Controllers\Physician\Notification\NotificationController;
use App\Http\Controllers\Physician\Chat\ChatController;
use App\Http\Controllers\Physician\ReminderSetting\ReminderSettingController;
use App\Http\Controllers\Physician\MedicalReport\MedicalReportController;
use App\Http\Controllers\Physician\Prescription\PrescriptionController;
...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::post('logout', [AuthController::class, 'logout'])->middleware('auth:physician');
...
Route::group(['middleware' => ['auth:physician', 'role:physician']], function () {
